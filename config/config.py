...
MONGO_DB_URI = getenv("MONGO_DB_UR", "mongodb+srv://music:music@cluster0.wvu0bo2.mongodb.net/?retryWrites=true&w=majority")
...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", " 𓆩᪵𝐌ᴇɴᴛᴀʟɪ𝐂🌿⃤𝐁𝐀𝐁𝐄𓆪̥")
